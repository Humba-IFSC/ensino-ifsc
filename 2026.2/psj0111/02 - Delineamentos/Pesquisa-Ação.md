...
### Metodologia de Intervenção Participativa e Transformadora
*Unidade Curricular: Metodologia de Pesquisa em Educação (PSJ0111) — IFSC Câmpus São José*

<div style="float: right; width: 310px; margin: 0 0 1em 1em; padding: 12px; border: 1px solid #3b82f6; border-radius: 8px; background-color: rgba(30, 41, 59, 0.6); font-size: 0.88em;">
  <div style="text-align: center; font-weight: bold; font-size: 1.05em; padding-bottom: 6px; border-bottom: 2px solid #3b82f6; margin-bottom: 8px; color: #60a5fa;">
    📑 INFOBOX DO DELINEAMENTO
  </div>
  <table style="width: 100%; border-collapse: collapse;">
    <tr><td style="padding: 3px 0; font-weight: bold;">Categoria:</td><td>Procedimento de Campo</td></tr>
    <tr><td style="padding: 3px 0; font-weight: bold;">Fonte Primária:</td><td>Intervenção e Ação Coletiva</td></tr>
    <tr><td style="padding: 3px 0; font-weight: bold;">Autores-Chave:</td><td>Thiollent, Tripp, Freire</td></tr>
    <tr><td style="padding: 3px 0; font-weight: bold;">Foco na EA:</td><td>Prática Reflexiva & Mudança Social</td></tr>
  </table>
</div>
...
A **Pesquisa-Ação** é definida por Michel Thiollent (2011) como um tipo de pesquisa social com base empírica que é concebida e realizada em estreita associação com uma ação ou com a resolução de um problema coletivo, no qual os pesquisadores e os participantes representativos da situação ou do problema estão envolvidos de modo cooperativo ou participativo.

David Tripp (2005) complementa enfatizando a natureza de **ciclos contínuos de reflexão-ação**:

1. **Planejamento:** Diagnóstico da situação real e elaboração de uma sequência didática ou plano de ação.
2. **Ação:** Implementação das atividades interventivas no ambiente educacional/institucional.
3. **Observação:** Registro sistemático dos efeitos, reações e evidências de aprendizagem.
4. **Reflexão:** Avaliação dos resultados para replanejar os próximos ciclos de formação.
...
## 👥 3. DISCENTES QUE ADOTAM A PESQUISA-AÇÃO NO VAULT MPE-2026-2
